...
integrating it tightly into your own emacs.

You can still use the prompting functions in a
basic way; The thin-client prompting function
names all start with =pen-fn-= and the names
of the fully-featured prompting functions all
begin with =pf-=.
...
work. If you don't have an OpenAI key, but
...
#+BEGIN_EXPORT html
<!-- Play on asciinema.com -->
<!-- <a title="asciinema recording" href="https://asciinema.org/a/org/a/lrC1HI8gdFfOwTd978FCVJexo" target="_blank"><img alt="asciinema recording" src="https://asciinema.org/a/org/a/lrC1HI8gdFfOwTd978FCVJexo.svg" /></a> -->
<!-- Play on the blog -->
<script src="https://asciinema.org/a/org/a/lrC1HI8gdFfOwTd978FCVJexo.js" id="asciicast-org/a/lrC1HI8gdFfOwTd978FCVJexo" async></script>
#+END_EXPORT
