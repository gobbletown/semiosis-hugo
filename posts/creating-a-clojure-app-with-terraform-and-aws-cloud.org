...
+ Automated user and policies management with =tabulated-list-mode= :: Using emacs, tablist and this tool (http://harelba.github.io/q/), create tabulated list modes for managing aws.
...
Demonstration of adding the =AdministratorAccess= policy to my =Administrator= user account.
